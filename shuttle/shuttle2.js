...
function str2dom(str) {//If you're expecting the HTML String to start with any content which is valid inside a <div>
...
function html2dom(str) {//If you're expecting the HTML String to start with <doctype>, <html>
